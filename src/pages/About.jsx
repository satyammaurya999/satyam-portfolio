  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I'm <strong>Satyam Maurya</strong> — a passionate{" "}
        ...
        <p>
          Computer Science and engineering student at ABES Engineering College with hands-on
          experience in full stack development
          Proficient in React, Node.js, Express, MongoDB, and JWT authentication.
          Solved 590+ LeetCode problems, focused on DSA and
          problem solving.
        </p>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Kendriya Vidyalaya AMC </strong> — Topkhana cantt (Lucknow)
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  May 2009 – Jun 2023
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Percentage: 77% | Grade: A
                </p>
                <p
                  style={{
                    color: "rgba(255,255,255,0.65)",
                ...
                >
                  Activities: Valley Ball Team, Cricket Player
                </p>
              </div>
            </motion.div>
